...
export const events = pgTable('events', {
  ...
  registrationNames: jsonb('registration_names').default({}),
  registrationBelts: jsonb('registration_belts').default({}),
  registrationsClosed: boolean('registrations_closed').default(false),
  locationCep: text('location_cep'),
